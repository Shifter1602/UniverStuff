...
namespace rk {
	...
	private: System::Windows::Forms::Label^  label4;
	   	 ...
	   	 void koord() {  
			 int x1,y1;
			 x1=this->ClientSize.Width-190;
			 y1=this->ClientSize.Height-40;
			 x[0]=x1-a/2;         
			 y[0]=y1-a/3;  	
			 x[1]=x1;
			 y[1]=y1-a; 
		  ...
		  void ris() {
			  ...
			  pen->Color=col->Green;
			  im->DrawLine(pen,int(x[1]),int(y[1]),int(x[2]),int(y[2]));
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"Поступательное (пикс.)";
			...
			this->label4->Text = L"Вращательное (град.)";
