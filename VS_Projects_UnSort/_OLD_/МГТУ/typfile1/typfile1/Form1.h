...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->ğàáîòàToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this-
>ñîğòèğîâêàÏîÂîçğàñòàíèşÍîìåğàToolStripMenuItem, 
			...
			this->ñîğòèğîâêàÏîÂîçğàñòàíèşÍîìåğàToolStripMenuItem->Click += gcnew System::EventHandler(this, 
&Form1::ñîğòèğîâêàÏîÂîçğàñòàíèşÍîìåğàToolStripMenuItem_Click);
			// 
