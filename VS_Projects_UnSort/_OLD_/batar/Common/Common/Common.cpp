...
// Common.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCommonApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CCommonApp::OnAppAbout)
...
CCommonApp::CCommonApp()
{
	...
	SetAppID(_T("Common.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CCommonApp

CCommonApp theApp;


// инициализация CCommonApp
...
// обработчики сообщений CCommonApp
...
// CCommonApp настройка методов загрузки и сохранения

void CCommonApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CCommonApp::LoadCustomState()
{
}

void CCommonApp::SaveCustomState()
{
}
