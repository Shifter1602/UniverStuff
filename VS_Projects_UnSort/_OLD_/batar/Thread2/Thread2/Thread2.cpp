...
// Thread2.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CThread2App

CThread2App theApp;


// инициализация CThread2App
...
// обработчики сообщений CThread2App
