...
BEGIN_MESSAGE_MAP(CDialogDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_START_BUTTON, &CDialogDlg::OnBnClickedStartButton)
END_MESSAGE_MAP()
...
void CDialogDlg::OnBnClickedStartButton()
{
	// TODO: добавьте свой код обработчика уведомлений
	UpdateData();
	MessageBox("Привет, " +m_edit, "Привет!", MB_ICONINFORMATION);
}
