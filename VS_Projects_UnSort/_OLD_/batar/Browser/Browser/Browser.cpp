...
// Browser.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBrowserApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBrowserApp::OnAppAbout)
...
CBrowserApp::CBrowserApp()
{
	...
	SetAppID(_T("Browser.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CBrowserApp

CBrowserApp theApp;


// инициализация CBrowserApp
...
// обработчики сообщений CBrowserApp
