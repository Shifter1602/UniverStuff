...
// Potok.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPotokApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CPotokApp::OnAppAbout)
...
CPotokApp::CPotokApp()
{
	...
	SetAppID(_T("Potok.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CPotokApp

CPotokApp theApp;


// инициализация CPotokApp

BOOL CPotokApp::InitInstance()
{
...
// обработчики сообщений CPotokApp
