...
// Word.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CWordApp

CWordApp theApp;


// инициализация CWordApp
...
// обработчики сообщений CWordApp
...
// CWordApp настройка методов загрузки и сохранения
