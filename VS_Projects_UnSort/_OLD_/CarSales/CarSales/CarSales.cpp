...
// CarSales.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCarSalesApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CCarSalesApp::OnAppAbout)
	// Стандартная команда настройки печати
	ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinApp::OnFilePrintSetup)
END_MESSAGE_MAP()


// создание CCarSalesApp

CCarSalesApp::CCarSalesApp()
{
	...
	SetAppID(_T("CarSales.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CCarSalesApp

CCarSalesApp theApp;


// инициализация CCarSalesApp

BOOL CCarSalesApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CCarSalesDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CCarSalesView));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений CCarSalesApp
