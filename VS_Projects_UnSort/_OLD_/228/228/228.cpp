...
// 228.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy228App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMy228App::OnAppAbout)
...
CMy228App::CMy228App()
{
	...
	SetAppID(_T("228.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMy228App

CMy228App theApp;


// инициализация CMy228App

BOOL CMy228App::InitInstance()
{
...
// обработчики сообщений CMy228App
