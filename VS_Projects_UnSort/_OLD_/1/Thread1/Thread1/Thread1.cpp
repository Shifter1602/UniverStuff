...
// Thread1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CThread1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CThread1App::OnAppAbout)
...
// создание CThread1App

CThread1App::CThread1App()
{
	...
	SetAppID(_T("Thread1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CThread1App

CThread1App theApp;


// инициализация CThread1App

BOOL CThread1App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CThread1Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CThread1View));
	if (!pDocTemplate)
		return FALSE;
...
// обработчики сообщений CThread1App
