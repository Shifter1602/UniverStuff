...
// MDI_test.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMDI_testApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMDI_testApp::OnAppAbout)
...
// создание CMDI_testApp

CMDI_testApp::CMDI_testApp()
{
	...
	SetAppID(_T("MDI_test.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMDI_testApp

CMDI_testApp theApp;


// инициализация CMDI_testApp

BOOL CMDI_testApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_MDI_testTYPE,
...
// обработчики сообщений CMDI_testApp
