...
// TestDLL.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestDLLApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CTestDLLApp::OnAppAbout)
...
CTestDLLApp::CTestDLLApp()
{
	...
	SetAppID(_T("TestDLL.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CTestDLLApp

CTestDLLApp theApp;


// инициализация CTestDLLApp
...
// обработчики сообщений CTestDLLApp
