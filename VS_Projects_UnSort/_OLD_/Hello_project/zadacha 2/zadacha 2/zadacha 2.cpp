...
// zadacha 2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Czadacha2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Czadacha2App

Czadacha2App::Czadacha2App()
{
...
// Единственный объект Czadacha2App

Czadacha2App theApp;


// инициализация Czadacha2App

BOOL Czadacha2App::InitInstance()
{
