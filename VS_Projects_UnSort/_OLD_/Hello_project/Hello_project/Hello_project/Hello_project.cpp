...
// Hello_project.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CHello_projectApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CHello_projectApp

CHello_projectApp::CHello_projectApp()
{
...
// Единственный объект CHello_projectApp

CHello_projectApp theApp;


// инициализация CHello_projectApp

BOOL CHello_projectApp::InitInstance()
{
