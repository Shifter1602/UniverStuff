...
// integr.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CintegrApp, CWinApp)
...
// Единственный объект CintegrApp

CintegrApp theApp;


// инициализация CintegrApp

BOOL CintegrApp::InitInstance()
{
