...
// Bvz.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBvzApp, CWinApp)
...
// Единственный объект CBvzApp

CBvzApp theApp;


// инициализация CBvzApp

BOOL CBvzApp::InitInstance()
{
