...
// Aplication2.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CAplication2App

CAplication2App theApp;


// инициализация CAplication2App
...
// обработчики сообщений CAplication2App
